...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item text-secondary">North Campus</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col">
                ...
                <div class="card card-primary">
                  ...
                  <div class="ribbon-wrapper ribbon-lg">
                    <div class="ribbon text-white text-bold" style="background-color: #e06c00;">
                      North Campus
                    </div>
                  </div>
                      ...
                      <form id="registerMemberForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col form-group">
                            ...
                            <input type="number" class="form-control form-control-border" id="register_yearGraduated"
                              name="register_yearGraduated" placeholder="Year Graduated" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col form-group">
                            ...
                            <input type="email" class="form-control form-control-border" id="register_emailAddress"
                              name="register_emailAddress" placeholder="Email Address" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col form-group">
                            ...
                            <select class="custom-select rounded-0" id="register_course" name="register_course"
                              required>
                          ...
                          <div class="col form-group">
                            ...
                            <select class="custom-select rounded-0" id="register_status" name="register_status"
                              required>
                        ...
                        <div class="row">
                          <div class="col form-group">
                            ...
                            <input type="file" class="form-control form-control-border" name="register_picture"accept="image/*"
                              required>
                          </div>
                        ...
                        <div class="row" id="affiliations_container">
                          ...
                          <div class="col form-group">
                            ...
                            <input type="text" class="form-control form-control-border"
                              id="register_affiliationsDuration" name="register_affiliationsDuration[]"
    ...
    <script>
      getMemberId("02", "../server/create_member-id.php"); //02 for Camarin/North Campus
